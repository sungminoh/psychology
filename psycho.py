...
@app.route('/')
@app.route('/visual-working-memory')
@app.route('/visual-working-memory/game')
@app.route('/visual-working-memory/history')
@app.route('/mental-rotation')
@app.route('/mental-rotation/game')
@app.route('/mental-rotation/history')
@app.route('/task-switching')
@app.route('/task-switching/game')
@app.route('/task-switching/history')
@app.route('/stop-signal-task/game')
@app.route('/stop-signal-task/history')
def index():
